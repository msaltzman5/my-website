    ...
    <div id='hobbies' className='content hobbies-content'>
      ...
      <div>
        ...
        <div className="hobbies-info">
          <div className="hobbies-info-left">
            ...
            <ImageCarousel images={getImagesFilePath()}/>
          </div> */}
            </div>
            <div className="basketball-content">
              ...
              <p>
                ...
                every few weeks. Peep my <a href="http://www.hudl.com/video/3/10453688/60026ec8d21ac70060c786b9" target="_blank" rel="noreferrer">junior season basketball "highlights"</a>.
              </p>
            </div>
...
function getImagesFilePath() {
  const importAll = (r) => r.keys().map(r);

  const images = importAll(require.context('../../Data/Hobbies/Bowling', false, /\.(png|jpe?g|svg)$/));
  return images;
}
